...
import sw.accounts.io.pocketmoney.CatamountSoftwareTransactionReader;
import sw.accounts.io.pocketmoney.GmbhTransactionReader;
...
public class ReportGeneratorTest
{
	...
	public void setupForCatamountSoftware() {
		testSubject = new ReportGenerator(
				...
				new PocketMoneyTransactionsReader( new CatamountSoftwareTransactionReader() ) );
	}
	...
	public void setupForGmbh() {
		testSubject = new ReportGenerator(
				...
				new CategorySummaryGenerator(),
				mockSummaryReportWriter,
				new PocketMoneyTransactionsReader( new GmbhTransactionReader() ) );
	}
}
